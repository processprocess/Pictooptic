...
/***/ function(module, exports, __webpack_require__) {
	...
	var _newRequest = __webpack_require__(1);
	
	var _newRequest2 = _interopRequireDefault(_newRequest);
	
	var _checkValue = __webpack_require__(19);
	
	var _checkValue2 = _interopRequireDefault(_checkValue);
	
	var _handleSubmitError = __webpack_require__(20);
	
	var _handleSubmitError2 = _interopRequireDefault(_handleSubmitError);
	
	var _handleChange = __webpack_require__(8);
	
	var _handleChange2 = _interopRequireDefault(_handleChange);
	
	var _handleWindowResize = __webpack_require__(21);
	
	var _handleWindowResize2 = _interopRequireDefault(_handleWindowResize);
	
	var _animations = __webpack_require__(9);
	
	var _getRandomVal = __webpack_require__(14);
	
	var _getRandomVal2 = _interopRequireDefault(_getRandomVal);
	
	var _generateAnimDomElements = __webpack_require__(17);
	
	var _staggerAnimation = __webpack_require__(18);
	
	var _staggerAnimation2 = _interopRequireDefault(_staggerAnimation);
	...
	var randomWordArray = ['abstract', 'astronaut', 'explosion', 'flower', 'girl', 'health', 'melt', 'pattern', 'person', 'smile', 'splatter', 'taco'];
	new Promise(function (resolve, reject) {
	  (0, _handleChange2.default)(randomWordArray[Math.floor((0, _getRandomVal2.default)(0, randomWordArray.length))], resolve);
	}); //for debugging
	...
	var randomWordButton = document.querySelector('.randomWord');
	
	logo.addEventListener('click', function (e) {
	  if (_animations.animateInRef.isActive()) return;
	  var randomWord = randomWordArray[Math.floor((0, _getRandomVal2.default)(0, randomWordArray.length))];
	  closeOverlay();
	  (0, _handleChange2.default)(randomWord);
	});
	...
	function handleKeydown(e) {
	  ...
	  if (e.keyCode === 27) {
	    ...
	    // enter
	    new Promise(function (resolve, reject) {
	      (0, _checkValue2.default)(overlayInput.value, resolve, reject);
	    }).then(function (checkedValue) {
	      new Promise(function (resolve, reject) {
	        (0, _handleChange2.default)(checkedValue, resolve);
	      });closeOverlay();
	    }).catch(function (err) {
	      (0, _handleSubmitError2.default)(err);
	    });
	  } else if (e.keyCode === 8) {
	    // delete
	...
	var overlayInput = document.querySelector('.searchOverlay input');
	var searchButton = document.querySelector('.searchButton');
	var searchInstructions = document.querySelector('.searchInstructions');
	...
	var compContainer = document.querySelector('.compContainer');
	
	compContainer.addEventListener('touchstart', function () {
	  // alert('touched');
	  (0, _staggerAnimation2.default)(_generateAnimDomElements.allAnimSets, 'changeLocation');
	  (0, _staggerAnimation2.default)(_generateAnimDomElements.allAnimSets, 'scale');
	  (0, _staggerAnimation2.default)(_generateAnimDomElements.allAnimSets, 'changeElementColors');
	  (0, _newRequest.randomColorRequest)();
	  (0, _animations.changeBGColor)(['.pageWrapper']);
	  closeOverlay();
	});
	...
	var currentSearch = document.querySelector('.currentSearch');
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.colorPallete = undefined;
	exports.default = newRequest;
	exports.randomColorRequest = randomColorRequest;
	
	var _superagent = __webpack_require__(2);
	
	var _superagent2 = _interopRequireDefault(_superagent);
	
	var _generateIconDom = __webpack_require__(7);
	
	var _generateIconDom2 = _interopRequireDefault(_generateIconDom);
	
	var _generateAnimDomElements = __webpack_require__(17);
	
	var _generateAnimDomElements2 = _interopRequireDefault(_generateAnimDomElements);
	
	var _staggerAnimation = __webpack_require__(18);
	
	var _staggerAnimation2 = _interopRequireDefault(_staggerAnimation);
	
	var _handleError = __webpack_require__(16);
	...
	function newRequest(param, resolve) {
	   _superagent2.default.get('/api/words/' + param).then(function (data) {
	      // document.write(JSON.stringify(data.body))
	      var cleanIconObjects = data.body;
	      (0, _generateIconDom2.default)(cleanIconObjects);
	
	      var allAnimSets = (0, _generateAnimDomElements2.default)(cleanIconObjects);
	      (0, _staggerAnimation2.default)(allAnimSets, 'animateIn');
	   }).catch(function (err) {
	...
	var colorPallete = exports.colorPallete = ["#00A0B0", "#6A4A3C", "#CC333F", "#EB6841", "#EDC951"];
	
	function randomColorRequest() {
	   _superagent2.default.get('/color').then(function (data) {
	      exports.colorPallete = colorPallete = data.body;
	      return data.body;
	   });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = generateIconDom;
	...
	function generateIconDom(cleanIconObjects) {
	  var currentSearchWord = document.querySelector('.currentSearchWord');
	  // currentSearchWord.textContent = searchTerm;
	  var nounDataWrapper = document.querySelector('.nounDataWrapper');
	  var domElementString = '';
	  var searchTerm = cleanIconObjects[0].term.toLowerCase();
	  currentSearchWord.addEventListener('click', function (e) {
	    infoOverlay.classList.remove('fadeIn');
	  });
	  cleanIconObjects.forEach(function (cleanIconObject, i) {
	    var liTagString = '';
	    var firstTag = cleanIconObject.tags[0];
	    // let collectionHTML;
	    ...
	    // } else { collectionHTML = '' }
	    cleanIconObject.tags.forEach(function (tag, i) {
	  ...
	  var authors = nounDataWrapper.querySelectorAll('.author');
	
	  authors.forEach(function (author) {
	    author.addEventListener('click', function () {
	      (0, _handleChange2.default)(this.textContent);
	      infoOverlay.classList.remove('fadeIn');
	    });
	    author.classList.add('clickable');
	  });
	
	  var tagSlugs = nounDataWrapper.querySelectorAll('li');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _removeDomNodes = __webpack_require__(15);
	...
	function handleChange(param, resolve) {
	  var nodesArray = document.querySelectorAll('.compContainer > div');
	  ...
	  // currentSearch.classList.add('currentSearchFade')
	  (0, _handleError.handleErrorRemove)();
	  (0, _animations.blackAndWhiteBG)();
	  new Promise(function (resolve, reject) {
	    (0, _animations.animateOut)(nodesArray, resolve);
	  }).then(function () {
	    return new Promise(function (resolve, reject) {
	      return (0, _removeDomNodes2.default)(nodesArray, resolve);
	    });
	  }).then(function () {
	    return (0, _newRequest2.default)(param, resolve);
	  }).then(function () {
	    if (!resolve) return;resolve('done with change request');
	  }); // tied to handleError
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.changingLocation = exports.animateInRef = undefined;
	exports.animateIn = animateIn;
	exports.changeLocation = changeLocation;
	exports.scale = scale;
	exports.changeBGColor = changeBGColor;
	exports.changeElementColors = changeElementColors;
	exports.blackAndWhiteBG = blackAndWhiteBG;
	exports.blackAndWhiteElements = blackAndWhiteElements;
	exports.animateOut = animateOut;
	
	__webpack_require__(10);
	
	var _ModifiersPlugin = __webpack_require__(12);
	...
	window.addEventListener('resize', function () {
	  return setResponsiveScale();
	});
	setResponsiveScale();
	
	/////////// animateIn ///////////
	
	var animateInRef = exports.animateInRef = void 0; //used in checkvalue.js
	
	function animateIn(animContainerL, animContainerR) {
	  var animateIn = new TimelineLite();
	  var startY = (0, _getRandomVal2.default)(window.innerHeight / 5.7, window.innerHeight / 1.27);
	  var startX = (0, _getRandomVal2.default)(window.innerWidth / 5, window.innerWidth / 2);
	  var rotation = (0, _getRandomVal2.default)(0, 30);
	  var scale = (0, _getRandomVal2.default)(0.2, responsiveScale);
	
	  exports.animateInRef = animateInRef = animateIn.fromTo([animContainerL, animContainerR], 1, {
	    y: startY,
	    x: startX,
	    rotation: 0,
	    scale: 0
	    ...
	    scale: scale,
	    modifiers: {
	      x: function x(value, animContainer) {
	        return animContainer === animContainerR ? window.innerWidth - value : value;
	      },
	      scaleX: function scaleX(value, animContainer) {
	        return animContainer === animContainerR ? -value : value;
	      },
	      rotation: function rotation(value, animContainer) {
	        return animContainer === animContainerR ? -value : value;
	      }
	    },
	    ease: Sine.easeInOut
	...
	var changingLocation = exports.changingLocation = void 0;
	
	function changeLocation(animContainerL, animContainerR) {
	  var endY = (0, _getRandomVal2.default)(window.innerHeight / 5.7, window.innerHeight / 1.27);
	  var endX = (0, _getRandomVal2.default)(window.innerWidth / 5, window.innerWidth / 2);
	  var _rotation = (0, _getRandomVal2.default)(0, 360);
	
	  exports.changingLocation = changingLocation = TweenMax.fromTo(animContainerL, 1, { // from
	...
	function scale(animContainerL, animContainerR) {
	  var scale = (0, _getRandomVal2.default)(0.2, responsiveScale);
	
	  if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
	    console.log('test');
	    scale = (0, _getRandomVal2.default)(0.05, responsiveScale);
	  }
	  ...
	  TweenMax.fromTo(animContainerR, .2, { // from
	    ...
	    scaleX: function scaleX(index, target) {
	      return scale * -1;
	    },
	    scaleY: function scaleY(index, target) {
	      return scale;
	    },
	    ease: Sine.easeInOut
	  });
	...
	function changeBGColor(elements) {
	  ...
	  TweenMax.to(elements, 1, { backgroundColor: _newRequest.colorPallete[Math.floor((0, _getRandomVal2.default)(0, _newRequest.colorPallete.length))], ease: Sine.easeInOut, delay: 0 });
	}
	
	function changeElementColors(animContainerL, animContainerR) {
	  animContainerL = animContainerL.querySelector('.maskImage');
	  animContainerR = animContainerR.querySelector('.maskImage');
	  var color = _newRequest.colorPallete[Math.floor((0, _getRandomVal2.default)(0, _newRequest.colorPallete.length))];
	...
	function blackAndWhiteBG() {
	  TweenMax.to('.pageWrapper', 1, { backgroundColor: 'rgba(255,255,255,0)', ease: Sine.easeInOut });
	}
	
	function blackAndWhiteElements(animContainerL, animContainerR) {
	  animContainerL = animContainerL.querySelector('.maskImage');
	  animContainerR = animContainerR.querySelector('.maskImage');
	  var oddOrEven = Math.floor((0, _getRandomVal2.default)(0, 2));
	  TweenMax.to([animContainerL, animContainerR], .2, {
...
/***/ function(module, exports) {
	...
	exports.default = removeDomNodes;
	function removeDomNodes(nodesArray, resolve) {
	  nodesArray.forEach(function (nodesArray) {
	    nodesArray.remove();
	  });
	  TweenMax.killAll();
	  if (!resolve) return;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.handleErrorRemove = handleErrorRemove;
	...
	var animElements = document.querySelectorAll('.compContainer .maskImage');
	
	/////////// handle error ///////////
	
	function handleError(err) {
	
	  var suggestionArray = ['pattern', 'geometry', 'puppy'];
	  var randSuggestion = suggestionArray[Math.floor((0, _getRandomVal2.default)(0, suggestionArray.length))];
	  // handleChange('error')
	  errorContainer.classList.add('errorFade');
	  errorContainer.innerHTML = '<div class=\'errorInfo\'>\n      <p class="errorBold">error</p>\n      <p>word not found</p>\n    </div>\n    <div class="error404"><p>404</p></div>\n    <div class=\'errorInfo\'>\n      <p>how about searching</p>\n      <p class="errorBold errorSuggestion">' + randSuggestion + '</p>\n    </div>';
	...
	function handleErrorRemove() {
	  ...
	  errorContainer.addEventListener('animationend', function (e) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.allAnimSets = undefined;
	exports.default = generateAnimDomElements;
	
	var _animations = __webpack_require__(9);
	
	var compContainer = document.querySelector('.compContainer');
	
	var allAnimSets = exports.allAnimSets = [];
	
	// export default function generateAnimDomElements (iconData) {
	function generateAnimDomElements(iconData, resolve) {
	  exports.allAnimSets = allAnimSets = [];
	  iconData.forEach(function (icon) {
	    var imageURL = icon.previewURL;
	    var animContainerL = document.createElement('div');
	    var animContainerR = document.createElement('div');
	    ...
	    animContainerL.addEventListener('mouseover', function (e) {
	      (0, _animations.changeLocation)(animContainerL, animContainerR);
	    });
	    animContainerR.addEventListener('mouseover', function (e) {
	      (0, _animations.changeLocation)(animContainerL, animContainerR);
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function staggerAnimation(allAnimSets, animationName, interval) {
	  if (!interval) {
	    interval = 30;
	  }
	  var animSetLength = allAnimSets.length;
	  if (animSetLength == 0) return;
	  var elementsAnimatedIn = 0;
	  var myInterval = setInterval(function () {
	    var currentAnimSet = allAnimSets[elementsAnimatedIn];
	    if (animationName === 'animateIn') {
	      (0, _animations.animateIn)(currentAnimSet[0], currentAnimSet[1]);
	    } else if (animationName === 'changeLocation') {
	      (0, _animations.changeLocation)(currentAnimSet[0], currentAnimSet[1]);
	    } else if (animationName === 'scale') {
	      (0, _animations.scale)(currentAnimSet[0], currentAnimSet[1]);
	    } else if (animationName === 'changeElementColors') {
	      (0, _animations.changeElementColors)(currentAnimSet[0], currentAnimSet[1]);
	    } else if (animationName === 'blackAndWhiteElements') {
	      (0, _animations.blackAndWhiteElements)(currentAnimSet[0], currentAnimSet[1]);
	    }
	    elementsAnimatedIn++;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function checkValue(value, resolve, reject) {
	  ...
	  // }
	  if (_animations.animateInRef.isActive()) {
...
/***/ function(module, exports) {
	...
	exports.default = handleSubmitError;
	function handleSubmitError(err) {
	  var searchInstructions = document.querySelector('.searchInstructions');
	  searchInstructions.textContent = err;
	  searchInstructions.classList.add('searchFlash');
	  searchInstructions.addEventListener('animationend', function (e) {
	    searchInstructions.classList.remove('searchFlash');
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = handleWindowResize;
	...
	}; // set page wrapper at start
	document.addEventListener('gesturestart', function (e) {
	  e.preventDefault();
	}); // dissable pinch re-sizing
