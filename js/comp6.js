function comp6() {
  ...
  function animateEl(animContainerL, animContainerR) {
    ...
    startYpos += window.innerHeight / totalElements * 2;
    ...
    // let tl = new TimelineLite({onComplete:animateEl, onCompleteParams:[animContainerL, animContainerR]}),
        ...
        endY = startY - window.innerHeight/4,
        // endY = startY - 200,
        // endY = random(0, window.innerHeight),
        endX =  (startYpos / window.innerHeight) * window.innerWidth/2,
        ...
        scale = (endY*2 / window.innerHeight) * scaleModifier,
